 ...
 * «Общая стоимость заказа [число] кредитов. Проверяем кол-во доступных средств на
 *  счету»
 *
...
let balance = 10000;
const payment = 20000;
let message = `«Общая стоимость заказа ${payment} кредитов. Проверяем кол-во доступных
средств на счету»`;
if (payment >= balance) {
